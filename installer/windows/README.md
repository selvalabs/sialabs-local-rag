...
This is the Windows local-app/shortcut MVP.
...
Those items are a later native-packaging milestone, not unfinished acceptance criteria for this script/shortcut MVP.
